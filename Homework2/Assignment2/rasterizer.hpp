...
namespace rst
{
    ...
    public:
        ...
        void set_pixel(const Eigen::Vector3f& point, const Eigen::Vector3f& color, int sample);
    ...
    private:
        ...
        std::vector<Eigen::Vector3f> frame_buf, temp_frame_buf[4];

        std::vector<float> depth_buf[4];
